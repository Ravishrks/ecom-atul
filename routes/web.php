...
Route::post('/save-for-later/{p_id}/{varient_id}/{qty}', 'SavelaterController@saveforlater')->name('save-for-later');

Route::post('/move-to-cart/{p_id}/{varient_id}/{qty}', 'SavelaterController@movetocart')->name('move-to-cart');
