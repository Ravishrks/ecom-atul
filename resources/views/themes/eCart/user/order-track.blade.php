                                                ...
                                                <div class="track-order">
                                                    ...
                                                    <div class="bs-wizard">
                                                        ...
                                                        <div class="bs-wizard-step complete">
                                                            ...
                                                            <a href="javascript:void(0)" class="bs-wizard-dot"></a>
                                                            <div class="bs-wizard-info text-center text-muted">{{ date("d-m-Y", strtotime($orderAwaiting_payment)) }}</div>
                                                            <div class="bs-wizard-info text-center text-muted">{{ date('h:i:s A', strtotime($orderAwaiting_payment)) }}</div>
                                                        </div>
                                                        @endif
                                                        @if($orderProcessed != "")
                                                        <div class="bs-wizard-step complete">
